...
public class PFrameLayout extends FrameLayout implements IPercentageLayout{
    ...
    public PFrameLayout(Context context, AttributeSet attrs){
        super(context, attrs);
        pLayout=new PercentageLayout(context, attrs, this);
    }

    public PFrameLayout(Context context, AttributeSet attrs, int defStyle){
