...
public class PHorizontalScrollView extends HorizontalScrollView implements IPercentageLayout{
	...
	public PHorizontalScrollView(Context context, AttributeSet attrs, int defStyle){
